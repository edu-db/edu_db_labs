...
@startuml
    ...
    |Система|
    : Перенаправляє користувача на сторінку із формою для створення теки з даними;

    |Користувач|
    : Заповнює обов'язкове поле форми, такі як назва теки з даними;
    : Натискає на кнопку "Створити нову теку";

    |Система|
    : Перевіряє, чи введені дані відповідають умовам створення теки з даними;
    note right #ffaaaa
    <b> Можливі
    ...
    : Додає введені дані користувачем у базу даних, створюючи нову теку з даними;
    : Повідомляє користувача про успішну операцію створення нової теки з даними;
    else (Ні)
    : Повідомляє користувача про виявлені помилки;
    endif
