...
@startuml
    ...
    if (Помилок не виявлено) then (Так)
    : Додає посилання на набір даних у \n вибрану користувачем теку з даними у базу даних;
    : Повідомляє користувача \n про успішну операцію додавання набору даних у теку;
    else (Ні)
    : Повідомляє користувача \n про виявлені помилки (DuplicationDataSetInDataFolder, FullDataFolder);
    endif
