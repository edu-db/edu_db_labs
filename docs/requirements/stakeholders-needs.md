...
- _PayServices_EX_IncorrectBankDetails_ - Клієнт надав не правильні банківські дані
...
**_НАЗВА:_** Видалити існуючу задачу в проєкті
...
**_НАЗВА:_** Змінити статус завдання
...
- _ChangeTaskStatus_EX_NotExist_ - Задачі не існує
...
**_НАЗВА:_** Надіслати завдання для огляду
...
- _SendingTaskForReview_EX_NotExist_ - Задачі не існує
...
- Захищеність (всі дані повинні бути захищенні, та системи по роботі з ними протестовані)
