...
| Основний сценарій | 1. Користувач натискає на кнопку реєстрації <br> 2. Користувач вводить дані <br> 3. Користувач підтверджує дані (можлива EX.01.01, EX01.02)<br> 4. Система заносить дані користувача в базу даних <br> 5. Система створює новий обліковий запис |
