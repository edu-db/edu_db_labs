...
| Основний сценарій | 1. Користувач натискає на кнопку реєстрації <br> 2. Користувач вводить дані <br> 3. Система заносить дані користувача в базу даних <br> 4. Система створює новий обліковий запис |
...
| Основний сценарій | 1. Користувач натискає на кнопку авторизації <br> 2. Користувач вводить дані <br> 3. Система дає запит до бази даних <br> 4. Система дає користувачу доступ до особистого кабінету |
...
| Основний сценарій | 1. Користувач натискає кнопку "Вихід з облікового запису" <br> 2. Система блокує корнистувачу доступ до особистого кабінету |
...
| Основний сценарій | 1. Користувач натискає кнопку "Видалити обліковий запис" <br> 2. Система дає запит видалення даних з бази даних <br> 3. Система видаляє обліковий запис |
