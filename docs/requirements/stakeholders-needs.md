...
|Виключні ситуації:|Такого користувача не існує EX.USER_DONT_EXISTS<br>Користувач вже є учасником проєкту EX.USER_IS_ALREADY_MEMBER<br>Такого проекту не існує EX.PROJECT_DONT_EXIST|
|Основний сценарій:|1.Користувач натискає кнопку "Додати учасника"<br>2.У вікні форми користувач вводить username або адресу електронної пошти учасника<br>3.Система перевіряє коректність введених даних<br>4.Користувач натискає кнопку "Додати"<br>5.Система надсилає сповіщення користувачу про призначення до проекту/команди<br>6.Система надсилає сповіщення про успішне призначення користувача<br>7.Система відображає користувача у списку учасників проекту/команди|
