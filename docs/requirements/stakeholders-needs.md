...
<table>
  ...
  <tr>
    <td>5. Система відправляє дані на перевірку до адміністратора</td>
  </tr>

  <tr>
    <td>6. Адміністратор перевіряє чи готові статистичні дані до публікації (можлива EDITOR.PUBLISH_DATA_ERROR)</td>
  </tr>
  ...
  <tr>
    <td>8. Система надає доступ користувачам до опублікованих на сайті статистичних даних</td>
  </tr>

  <tr>
    <td>9. Редактор отримує підтвердження про успішну публікацію статистичних даних на сайті</td>
  </tr>
...
<table>
  ...
  <tr>
    <td>3. Адміністратор розпочинає взаємодію</td>
  </tr>

  <tr>
    <td>4. Адміністратор переходить до панелі адміністратора та обирає опцію управляння заявками на публікацію</td>
  </tr>

  <tr>
    <td>5. Адміністратор натискає на заявку для її перегляду</td>
  </tr>

  <tr>
    <td>6. Адміністратор перевіряє чи готові дані до публікації (можлива ADMIN.PUBLICATION_VERIFICATION_ERROR)</td>
  </tr>

  <tr>
    <td>7. Адміністратор підтверджує публікацію даних</td>
  </tr>

  <tr>
    <td>8. Система надає користувачам доступ до опублікованих на сайті статистичних даних</td>
  </tr>

  <tr>
    <td>9. Адміністратор отримує підтвердження про успішну публікацію статистичних даних</td>
  </tr>

  <tr>
    <td>10. Адміністратор закінчує взаємодію</td>
  </tr>
</table>
