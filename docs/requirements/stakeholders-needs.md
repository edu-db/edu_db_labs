...
* [Характеристика ділових процесів](#характеристика-ділових-процесів)
  ...
  * [PROJECT.CREATE](#PROJECT.CREATE) (Створити проект)
  * [PROJECT.DELETE](#PROJECT.DELETE) (Видалити проект)
...
| :----------------- | :----------- |
| Назва:             | Створити обліковий запис користувача|
...
| Виключні ситуації: | Користувач не ввів реєстраційні дані та намагається зареєструватися EX.NO.REGISTRATION.DATA<br>
Обліковий запис користувача вже створений у системі EX.ACCOUNT.ALREADY.EXISTS|
| Основний сценарій: | 1. Користувач починає взаємодію<br>2. Користувач вводить реєстраційні дані<br>3. Користувач натискає кнопку "Зареєструватися" (можлива EX.NO.REGISTRATION.DATA)<br>4. Система перевіряє наявність облікового запису користувача (можлива EX.ACCOUNT.ALREADY.EXISTS)<br>5. Система створює новий обліковий запис<br>6. Користувач отримує інформацію про успішну реєстрацію<br>7. Користувач закінчує взаємодію|
...
| Виключні ситуації: | Користувач не вписав авторизаційні дані та намагається авторизуватися EX.NO.AUTHORIZATION.DATA<br>Користувач не зареєстрований у системі EX.ACCOUNT.DOESNT.EXIST<br>Користувач не пройшов авторизацію (ввів неправильний пароль) EX.WRONG.PASSWORD|
| Основний сценарій: | 1. Користувач починає взаємодію<br>2. Користувач вводить авторизаційні дані<br>3. Користувач натискає кнопку "Увійти" (можлива EX.NO.AUTHORIZATION.DATA)<br>4. Система перевіряє наявність облікового запису користувача (можлива EX.ACCOUNT.DOESNT.EXIST)<br>5. Система перевіряє отримані авторизаційні дані (можлива EX.WRONG.PASSWORD)<br>6. Система надає користувачу доступ до облікового запису<br>7. Користувач отримує інформацію про успішну авторизацію<br>8. Користувач закінчує взаємодію|

| ID                 | <span id=TASK.CREATE>`TASK.CREATE`</span>|
| :----------------- | :----------- |
| Назва:             | Створити завдання|
| Учасники:          | Користувач (менеджер проекту, тімлід або робітник), система|
| Передумови:        | Користувач має доступ до функціоналу системи|
| Результат:         | Завдання створено|
| Виключні ситуації: | -Користувач не має необхідних прав для доступу до функціоналу системи EX.TASK.ACCESS.DENIED<br>-Користувач ввів некоректні дані EX.TASK.INVALID.DATA|
...
| Виключні ситуації: | -Користувач не має необхідних прав для доступу до функціоналу системи EX.TASK.ACCESS.DENIED<br>-Користувач ввів некоректні дані
EX.TASK.INVALID.DATA<br>-Задачі не існує EX.TASK.DOESNT.EXIST|
| Основний сценарій: | 1. Користувач вводить назву завдання та опис<br>2. Система перевіряє коректність введених даних<br>3. Система редагує завдання<br>4. Користувач отримує повідомлення про успішне редагування завдання|
...
- додавати та редагувати завдання 
- створювати спринти 
