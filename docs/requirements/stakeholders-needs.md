...
**FAQ**[[3]](#link3) ***(frequently asked questions)*** - список загальних запитань, що мають тенденцію повторюватися, наприклад, через дописи чи запити нових користувачів, та відповіді на них. 
...
- Постійне тестування коду, щоб виявляти помилки та удосконалювати вебсайт
