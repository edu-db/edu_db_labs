...
<table style="width:110%; border: 1px solid black">
  ...
  <tr>
    ...
    4. Менеджер проєкту заповнює форму створення дошки (назва, менеджер проєкту, члени команди).<br>
    ...
    7. Система надсилає менеджеру проєкту повідомлення про успішне створення дошки.<br>
    8. Менеджер проєкту отримує повідомлення про успішне створення дошки.<br>
...
<table style="width:110%; border: 1px solid black">
  ...
  <tr>
    ...
    5. Менеджер проєкту заповнює форму створення завдання. (TaskCreate_EX_NoName, TaskCreate_EX_NoDescr, TaskCreate_EX_NoUser)<br>
    ...
    6. Система відкриває форму редагування завдання з попередніми даними завдання.<br>
    8. Менеджер проєкту редагує дані в формі (назва, опис, дедлайн, відповідальний, пріоритет, статус).<br>
    9. Менеджер проєкту натискає кнопку «Зберегти».<br>
    10. Система надсилає менеджеру повідомлення «Ви точно бажаєте зберегти останні зміни?». (TaskEdit_EX_Cancelled)<br>
    11. Менеджер проєкту підтверджує редагування натисканням кнопки «Так».<br>
    12. Менеджер проєкту отримує повідомлення про успішне редагування завдання проєкту.<br>
    13. Менеджер проєкту закінчує взаємодію.</td>
  </tr>
</table>
