...
_для студентів напряму підготовки 123 "Комп’ютерна інженерія" всіх форм навчання_
...
1. Визначити призначення розроблюваної системи за структурою списку запитів
...
**_Прецедент (англ. Use Case)_** – список етапів, що послідовно описує взаємодію
...
- **_Асоціація (англ. Association)_** – вказує на те, що Actor ініціює відповідний
  варіант використання.

- **_Розширення (англ. Extend)_** – різновид відношення залежності між базовим
  варіантом використання та його частковим випадком.

- **_Включення (англ. Include)_** – визначає зв'язок базового варіанта використання
  з іншим, функціональна поведінка якого завжди задіюється базовим варіантом.

- **_Узагальнення (англ. Generalization, наслідування)_** – моделює відповідну
  спільність ролей.

**_Actor_** – діюча особа (користувач, система, програма), спроможна приймати
рішення та взаємодіяти з розроблюваною системою.

**_Діаграма Use Case_** – абстраговане представлення компонентів бази даних, дій та
зв’язків між ними.

**_Специфікация_** - це формалізований опис властивостей, характеристик і функцій
об'єктів.
...
**_Сценарій_** - послідовність дій, що мають бути виконані для досягнення
...
_ID:_ **UC_CreateRegCard**

_Назва:_ Створення реєстраційної картки користувача

_Учасники:_ Адміністратор, Система

_Передумова:_ Адміністратор авторизований в системі
...
_Результат_ Деактивована реєстраційна карта нового клієнта.
...
**_Бізнес-моделювання (ділове моделювання)_** - діяльність з формування моделей
...
**_Пакет_** використовується для групування бізнес об’єктів.

![](media/a04dfabb76e4bedc8704d33284c56f52.png)

**_Елемент бізнес-сутність_**
...
**_Асоціативний зв'язок (association)_** між бізнес-сутностями (business entity) є
...
**_Зв'язок композиція_** позначає зв'язок частина цілого (part of), де частина не може
...
**_Зв'язок агрегація_** означає зв'язок частина цілого (part of), де частина може
...
**_Спадкування_** або зв'язок батько-нащадок (generalization) між бізнес об’єктами -
...
**_Заголовок (схема) відношення_** — скінченна множина впорядкованих пар виду \<A,
...
**_Кортеж,_** відповідний заголовку — множина впорядкованих триплетів \<A, T, v\>, по
...
**_Тіло відношення_** — невпорядкована множина різних кортежів.
...
**_Реляційна алгебра_** — відгалуження логіки першого порядку, множина відношень
...
3.  Після інсталяції обираємо пункт _Configure the MySQL Server now-\>Finish_
...
**_Data Definition Language (мова опису даних)._** За допомогою цієї мови визначають
...
Оператор **_create table_** створює таблицю з заданим ім'ям у поточній базі даних.
...
Оператор **_Drop table_** видаляє одну чи кілька таблиць.
...
Оператор **_Alter table_** забезпечує можливість змінювати структуру існуючої
...
**_Data Manipulation Language (мова управління (маніпулювання) даними)._** Це мова
керування даними, за допомогою якого можна витягувати і змінювати дані.

Для **_вибірки даних_** з БД використовується запит `SELECT`. Він дозволяє робити
...
Тепер ми хочемо вибрати зміст колонок під назвою "_LastName_ " та "_FirstName_"
з таблиці вище.
...
**_DAO_** - об'єкт що надає абстрактний інтерфейс до деяких видів баз даних чи
...
**_Active Record_** - це шаблон проектування, що використовується при реалізації доступу до реляційних баз даних. Вперше згадується Мартіном Фаулером в книжці Patterns of Enterprise Application Architecture. Цей шаблон є підвидом DAO, але навідміну від нього, він надає CRUD API кожному окремому об'єкту, який репрезентує окремий запис в таблиці БД.
