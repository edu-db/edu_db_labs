...
За допомогою модуля uvicorn, який дозволяє нам взаємодіяти із сервісом Swagger UI ми запускаємо наш застосунок, додаючи до адреси 
